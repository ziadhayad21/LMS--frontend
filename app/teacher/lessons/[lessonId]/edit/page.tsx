...
export default async function EditLessonPage({
  ...
  if (!courseId) {
    // If courseId is missing, redirect to courses since lessons belong to courses
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      <div>
        <Link href={`/teacher/courses/${courseId}`} className="text-sm text-slate-400 hover:text-slate-600 transition-colors">
          ← Back to Course
        </Link>
